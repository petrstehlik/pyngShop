...
% Reference
% Seznam použitých zdrojů (v textu citujte/odkazujte se).
% Externí produkty (youtube, Adobe apod.), tutoriály, návody nebo nerecenzované články uvádějte v poznámce pod čarou, ne jako literaturu. Wiki lze považovat za recenzovaný zdroj - tedy můžete dávat do literatury.
